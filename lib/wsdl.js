...
MessageElement.prototype._getNestedLookupTypeString = function (element) {
  var ignoredNamespaces = this.options ? this.options.ignoredNamespaces
      : this.ignoredNamespaces;
  var resolvedType = '^',
      excluded = ignoredNamespaces.concat('xs'); // do not process $type values wich start with
...
WSDL.prototype.ignoreChildBaseNameSpaces = false;
...
WSDL.prototype._initializeOptions = function (options) {
  ...
  var ignoreChildBaseNameSpaces = options ? options.ignoreChildBaseNameSpaces : null;
  if(ignoreChildBaseNameSpaces !== null && typeof ignoreChildBaseNameSpaces !== 'undefined' )
    this.options.ignoreChildBaseNameSpaces = ignoreChildBaseNameSpaces;
  else
    this.options.ignoreChildBaseNameSpaces = this.ignoreChildBaseNameSpaces;
            ...
            if (childSchemaObject &&
              ...
              if (elementQName) {
                ...
                if (elementQName.prefix === TNS_PREFIX) {
                  ...
                  for (i = 0, n = this.options.ignoredNamespaces.length; i < n; i++) {
                    if (this.options.ignoredNamespaces[i] === childNsPrefix) {
              ...
              if (!this.options.ignoreChildBaseNameSpaces) {
